...
from nba_data_platform.transforms import transform_stints
from nba_data_platform.transforms.stint_processor import StintProcessor
import pandas as pd
import polars as pl
...
if TYPE_CHECKING:
    from nba_data_platform.pipelines.playbyplay import PlayByPlayPipeline
