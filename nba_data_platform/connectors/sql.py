from nba_data_platform.config.settings import DATABASES, TABLES 
from urllib.parse import quote_plus
from sqlalchemy import create_engine, text, Numeric
from nba_data_platform.transforms.stint_processor import StintResult
import pyodbc
import logging
import datetime
import polars as pl
...
from nba_data_platform.sql import query
    ...
    def check_tables(self):
        ...
        for table, config in self.tables.items():
            ...
            try:
                ...
                self.logger.error(f'{table} state check failed!')
            bp = 'here'
