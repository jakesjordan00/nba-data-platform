...
def nba_pipeline():
    @task
    def run_schedule():
        from nba_data_platform.pipelines import DailyBackfillSchedulePipeline
    ...
    def run_boxscore(game):
        from nba_data_platform.pipelines import BoxscorePipeline
        GameID = game['GameID']
    ...
    def run_playbyplay(boxscore_result):
        from nba_data_platform.pipelines import PlayByPlayPipeline
